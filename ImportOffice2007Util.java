package top.gerritchang.daily.utils;
...
import top.gerritchang.daily.entity.ImportEntity;
import top.gerritchang.daily.exception.ColumnIsNullException;
import top.gerritchang.daily.exception.MissingColumnsException;
import top.gerritchang.daily.exception.ValueContainsSpecialCharException;
...
public class ImportOffice2007Util {
                ...
                if (!"".equals(cell) && cell != null) {
                    switch (cell.getCellType()) {
                        case XSSFCell.CELL_TYPE_NUMERIC: // 数字
                            ...
                            } else if(cell.toString().indexOf("E")>0){
